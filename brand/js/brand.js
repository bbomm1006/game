$(function() {
    ...
    $(".btn_char_video").on("click", function() {
        ...
        if(!iOS()) {
            //loop 사용시 무한 재생
            var getVideo = '<video muted autoplay playsinline loop class="pc"><source src="'+getPc+'.webm" type="video/webm" /></video><video muted autoplay playsinline loop class="mobile"><source src="'+getMobile+'.webm" type="video/webm" /></video>';
